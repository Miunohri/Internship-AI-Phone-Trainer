...
- Developed AI evaluation prompts and structured JSON response schemas using the OpenAI API.
- Contributed to a configurable scorecard evaluation system for evaluating training transcripts.
- Worked with frontend and backend developers to integrate AI evaluation results and performance analytics.
- Performed UI and functional testing, including customer persona randomization, error handling, and over application behavior.
- Tested AI workflows for response validation and scoring consistency.
